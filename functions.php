...
function schtroumpfie_scripts() {
  wp_enqueue_style( 'uikit_css', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.20/css/uikit.min.css' );
  wp_enqueue_style( 'custom_css', get_template_directory_uri() . '/css/custom.css' );
  wp_enqueue_script( 'uikit_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.20/js/uikit.min.js', array( 'jquery' ), true );
  wp_enqueue_script( 'uikit_icons_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.20/js/uikit-icons.min.js' );
  wp_enqueue_script( 'slider', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.20/js/components/slider.min.js', true );
  wp_enqueue_script( 'slideshow_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.17/js/components/slideshow.min.js', true );
  wp_enqueue_script( 'lightbox_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.17/js/components/lightbox.min.js', true );
}
