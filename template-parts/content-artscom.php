<?php //* The Query
  ...
  if ( $exec_query->have_posts() ) { ?>
    ...
    <div class="uk-section">
      <div class="uk-padding@s uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-4@m uk-grid-small" uk-grid="masonry: true; parallax: 150" uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 200">
